            ...
            <ul class="flex flex-col pl-0 mb-0">
                ...
                <li class="mt-0.5 w-full">
                    <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors"
                        ...
                        <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Donasi Bencana</span>
                    </a>
                </li>
                ...
                <li class="mt-0.5 w-full">
                    <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors"
                        ...
                        <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Logistik</span>
                    </a>
                </li>
                ...
                <li class="mt-0.5 w-full">
                    <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors"
                        ...
                        <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Distribusi
                            Logistik</span>
                    </a>
                </li>
                ...
                <li class="mt-0.5 w-full">
                    <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors"
                        ...
                        class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Sign In</>
                    </a>
                </li>
            </ul>
        </div>
        ...
        <nav class="relative flex flex-wrap items-center justify-between px-0 py-2 mx-6 transition-all shadow-none duration-250 ease-soft-in rounded-2xl lg:flex-nowrap lg:justify-start"
            ...
            <div class="flex items-center justify-between w-full px-4 py-1 mx-auto flex-wrap-inherit">
                <nav>
                    ...
                    <h6 class="mb-0 font-bold capitalize">Bina Desa</h6>
                </nav>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <input type="number" name="rt" class="w-full p-2 border rounded-lg"
                                        placeholder="RT" value="{{ old('rt', $kejadian->rt) }}">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="number" name="rw" class="w-full p-2 border rounded-lg"
                                        placeholder="RW" value="{{ old('rw', $kejadian->rw) }}">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="dampak" class="w-full p-2 border rounded-lg"
                                        placeholder="Contoh: Rumah Rusak 20 Unit"
                                ...
                                <div class="mt-4">
                                    <label class="block text-sm font-medium text-gray-700">Upload Media Baru
                                        (Opsional)</label>
